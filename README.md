...
![과제4 실행화면](img/capture5.png)
![과제4 실행화면](img/capture6.png)


-과제내용  
 선택하는 순간 ListBox에 주문 내역이 표시됨  
 선택하는 순간 Label에 전체가격 정보가 표시됨  
-구현내용과 기능설명  
결제 전 사용자가 주문 내용을 최종 확인하는 단계를 추가하여 오주문을 방지하는 로직을 구현  
각 라디오버튼과 체크박스의 CheckedChanged 이벤트를 사용해서 실시간으로 금액이 반영됨
